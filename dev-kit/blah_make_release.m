function blah_make_release(newVersion)
% Cut a release of repro-poi-corrupt-xml
%
% blah_make_release newVersion
%
...
echo("   https://github.com/apjanke/repro-poi-corrupt-xml/releases")
if ismac
  % TODO: Figure out how to do this on Windows and Linux
  system('open "https://github.com/apjanke/repro-poi-corrupt-xml/releases"')
end
